"""
Fix ENEM metadata using CONTENT-ONLY discipline detection.
Ignores question number for discipline - uses only text analysis.
Area is kept by dia+numero (ENEM standard).
"""
...
# WEIGHTED keywords: each keyword has a weight (higher = more important)
# Only keywords that are VERY specific to a discipline are included
DISCIPLINE_SIGNALS = {
    'fisica': [
        ...
        ('rádio', 2), ('micro-ondas', 3), ('infravermelho', 3),
        ('ultravioleta', 3), ('raios x', 5), ('raios gama', 5),
        ...
        ('supercondutividade', 8), ('supracondutividade', 8),
        ('relatividade', 8), ('espaço-tempo', 8), ('dilatação', 3),
        ('quântica', 8), ('incerteza', 5), ('dualidade', 5),
    ],
    'quimica': [
        ('átomo', 3), ('molécula', 3), ('elemento', 2), ('liga metálica', 5),
        ('tabela periódica', 8), ('grupo', 1), ('período', 1),
        ('ligação iônica', 8), ('ligação covalente', 8), ('ligação metálica', 8),
    ...
    'biologia': [
        ...
        ('rnusp', 5), ('factor', 5), ('alelo', 5), ('genótipo', 5), ('fenótipo', 5),
    ...
    'historia': [
        ...
        ('monarquia', 3), ('democracia', 2), ('ditadura', 2),
        ('sistema econômico', 3), ('mercantilismo', 5), ('capitalismo', 3),
        ('socialismo', 3), ('feudalismo', 5),
        ('igreja', 2), ('católica', 2), ('protestante', 3), ('reforma protestante', 8),
        ('contrarreforma', 8), ('inquisição', 5),
        ('expansão marítima', 8), ('navegação', 3), ('descoberta', 2),
        ('tas do brasil', 5), ('capitanias hereditárias', 8), ('administração colonial', 8),
        ('cultura colonial', 5), ('sociedade colonial', 5),
        ('mineração', 2), ('ouro', 1), ('diamante', 2),
        ('escravatura', 5), ('tráfico de escravos', 8),
        ('inconfidência', 8), ('conjuração', 5), ('inconfidentes', 8),
        ('tiradentes', 8), ('dom倮io', 5), ('marquês de pombal', 8),
        ...
        ('urbanização', 2), ('proletariado', 5), ('burguesia', 3),
        ...
        ('iei', 5), ('sem terra', 5), ('movimento operário', 8),
        ('primeira república', 8), ('decreto num', 3),
        ('1930', 3), ('1937', 3), ('1945', 3), ('1964', 3), ('1985', 3),
        ('1822', 3), ('1889', 3), ('1888', 3), ('1500', 3),
        ('pedro i', 5), ('pedro ii', 5), ('deodoro', 5), ('floriano', 5),
        ('prudente', 3), ('campos sales', 5), ('rodrigues alves', 5),
        ('washington luís', 5), ('julio prestes', 5),
    ],
    'geografia': [
        ...
        ('produção', 1), ('consumo', 1), ('distribuição', 1),
    ...
    'filosofia': [
        ...
        ('iluminismo', 5), ('racionalismo', 8), ('idealismo', 5),
        ('pragmatismo', 5), ('neopositivismo', 8), ('analytic', 5),
        ('marxismo', 5), ('anarquismo', 5), ('liberalismo', 3),
        ('comunitarismo', 5), ('cosmopolitismo', 5),
        (' bioética', 8), ('eutanásia', 5), ('aborto', 3), ('pena de morte', 5),
        ('justiça social', 5), ('desigualdade', 2), ('direitos humanos', 5),
    ...
    'portugues': [
        ...
        ('tom', 2), ('ironia', 3), ('sarcasmo', 5), ('humor', 2),
        ('ambiguidade', 5), ('equívoco', 5), ('polissemia', 5),
        ('denotação', 8), ('conotação', 8),
        ('figuras de linguagem', 8), ('figuras de sentido', 8),
        ('metonímia', 5), ('sinédoque', 5), ('antítese', 5),
        ('paradoxo', 5), ('símile', 5), ('comparação', 3),
    ...
    'estatistica': [
        ...
        ('interpretar', 2), ('analisar', 2), ('ler', 1),
...
def detect_discipline(texto, area):
    ...
    # Score each discipline using weighted keywords
    scores = {}
    for disc in disciplines:
        signals = DISCIPLINE_SIGNALS.get(disc, [])
        score = 0
    ...
    # Return discipline with highest score (must have at least some evidence)
...
# Subtopic detection with context
SUBTOPIC_KEYWORDS = {
    'historia': {
        ...
        'Guerra Fria': [('guerra fria', 10), ('urss', 5), ('eua', 2), ('bloco soviético', 8), ('bloco ocidental', 8)],
...
def main():
    ...
    for question in q:
        ...
        # Fix discipline based on content only
        correct_disc = detect_discipline(texto, area)
    ...
    print(f"Fixed: {disc_fixed} disciplines, {sub_fixed} subtopics")
